    ...
    render(){
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <div class="d-flex align-items-center mr-2 ml-2">
                                <button type="button" class="btn btn-primary btn-block waves-effect waves-themed position-relative" data-toggle="modal" data-target="#addProject"> <i class="fal fa-plus-square d-inline-block mr-1"></i> New Project</button>
                            </div>
                            ...
                            <li class="nav-title">Modules</li>
                             <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    ...
                                    <span class="nav-link-text" data-i18n="nav.category">Announcement</span>
                                </a>
                            </li>
                            <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    <i class="fal fa-bell"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Alerts</span>
                                </a>
                            </li>
                            <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    <i class="fal fa-gamepad-alt"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Games</span>
                                </a>
                             </li>
                            <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    <i class="fal fa-shield-alt"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Moderation</span>
                                </a>
                            </li>
                            <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    <i class="fal fa-music"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Music</span>
                                </a>
                             </li>
                             <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    <i class="fal fa-atlas"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Trivia</span>
                                </a>
                             </li>
                             <li>
                                <a href="#/" title="Category" data-filter-tags="category">
                                    <i class="fal fa-cloud-sun-rain"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Weather</span>
                                </a>
                             </li>
                        </ul>
                    </nav>
		...
		A nice area to add graphs or buttons --> */}
                        ...
                        <div class="d-flex justify-content-center">
                            <h1><span class="fw-300"><i>No Projects Found</i></span></h1>
                        </div>
                        ...
                        <ul class="list-group">
                          <a href="#/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            ...
                            <span class="fa-2x"> <i class="fal fa-star"></i></span>
                            <h5 class="ml-3" style={{marginBottom: "0px"}}>Bot Project 1</h5>
                            </div>
                            
                            <div class="d-flex justify-content-end align-items-center">
                            <button type="button" class="btn btn-primary waves-effect waves-themed position-relative mr-2">Add Modules</button>
                            <button type="button" class="btn btn-secondary waves-effect waves-themed position-relative mr-2" data-toggle="modal" data-target="#lEdit">Edit</button>
                            <button type="button" class="btn btn-danger waves-effect waves-themed position-relative" data-toggle="modal" data-target="#lDelete">Delete</button>
                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label class="form-label" for="simpleinput">Project name</label>
                                            <input type="text" id="projectname" class="form-control" placeholder="Enter project name here" />
                                        </div>
                                    </div>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label class="form-label" for="simpleinput">Discord Bot Token</label>
                                            <input type="text" id="bottoken" class="form-control" placeholder="Enter your Discord Bot Token here" />
                                        </div>
                                    </div>
                        ...
                        <div class="modal fade" id="lAddModules" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Add a new project</h5>
                         ...
                         <div class="modal-dialog modal-lg modal-dialog-centered">
                          <div class="modal-content">
                           ...
                           <div class="modal-header card-header-title text-center">  
                            <h4 class="modal-title card-element-title w-100 pl-5">Pricing</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                                </button>
                           </div>   
                            <div class="modal-body container">
                                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="col-4 rounded text-center" style={{border:"2px solid #cecece"}}>
                                    <h1 class="text-center display-4">Basic</h1>
                                    <h4 class="text-center"><span class="fw-900">$8.99</span> / month</h4>
                                    <button type="button" class="btn btn-outline-primary waves-effect waves-themed m-2">Purchase</button>
                                    <div class="list-group border-2">
                                      <div class="list-group-item border-primary border-top-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> Upto 2 Projects</div>
                                      <div class="list-group-item border-primary border-top-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> Custom Status</div>
                                      <div class="list-group-item border-primary border-top-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> Extra Modules</div>
                                      <div class="list-group-item border-primary border-top-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> No Advertisements</div>
                                      <div class="list-group-item border-primary border-bottom-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> Superfast Server</div>
                                    </div>
                                    </div>

                                    <div class="col-4 rounded text-center" style={{border:"2px solid #cecece"}}>
                                        <h1 class="text-center display-4">Pro</h1>
                                        <h4 class="text-center"><span class="fw-900">$8.99</span> / month</h4>
                                        <button type="button" class="btn btn-outline-primary waves-effect waves-themed m-2">Purchase</button>
                                        <div class="list-group border-2">
                                          <div class="list-group-item border-primary border-top-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> Upto 2 Projects</div>
                                        ...
                                        <div class="col-4 rounded text-center" style={{border:"2px solid #cecece"}}>
                                        <h1 class="text-center display-4">Ultra</h1>
                                        <h4 class="text-center"><span class="fw-900">$8.99</span> / month</h4>
                                        <button type="button" class="btn btn-outline-primary waves-effect waves-themed m-2">Purchase</button>
                                        <div class="list-group border-2">
                                              <div class="list-group-item border-primary border-top-0 border-right-0 border-left-0 text-center"><i class="fal fa-check"></i> Upto 2 Projects</div>
                ...
                <div class="modal-content h-100">
                    <div class="dropdown-header bg-trans-gradient d-flex align-items-center w-100">
                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                            <span class="mr-2">
                                <span class="rounded-circle profile-image d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-d.png')", backgroundSize: "cover"}}></span>
                            </span>
                            <div class="info-card-text">
                                <a href="#/" class="fs-lg text-truncate text-truncate-lg text-white" data-toggle="dropdown" aria-expanded="false">
                                    Tracey Chang
                    ...
                    <div class="modal-body p-0 h-100 d-flex">
                        ...
                        <div class="msgr-list d-flex flex-column bg-faded border-faded border-top-0 border-right-0 border-bottom-0 position-absolute pos-top pos-bottom">
                                    ...
                                    <ul id="js-msgr-listfilter" class="list-unstyled m-0">
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="tracey chang online">
                                                <div class="d-table-cell align-middle status status-success status-sm ">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-d.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="oliver kopyuv online">
                                                <div class="d-table-cell align-middle status status-success status-sm ">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-b.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        Oliver Kopyuv
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="dr john cook phd away">
                                                <div class="d-table-cell align-middle status status-warning status-sm ">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-e.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        Dr. John Cook PhD
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney online">
                                                <div class="d-table-cell align-middle status status-success status-sm ">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-g.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        Ali Amdaney
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="sarah mcbrook online">
                                                <div class="d-table-cell align-middle status status-success status-sm">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-h.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        Sarah McBrook
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney offline">
                                                <div class="d-table-cell align-middle status status-sm">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-a.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney busy">
                                                <div class="d-table-cell align-middle status status-danger status-sm">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-j.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        oliver.kopyuv@gotbootstrap.com
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney offline">
                                                <div class="d-table-cell align-middle status status-sm">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-c.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        oliver.kopyuv@gotbootstrap.com
                                        ...
                                        <li>
                                            <a href="#/" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney inactive">
                                                <div class="d-table-cell align-middle">
                                                    <span class="profile-image-md rounded-circle d-block" style={{backgroundImage:"url('img/demo/avatars/avatar-m.png')", backgroundSize: "cover"}}></span>
                                                </div>
                                                <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                    <div class="text-truncate text-truncate-md">
                                                        +714651347790
                            ...
                            <div>
                                <a href="/#" class="fs-xl d-flex align-items-center p-3">
                        ...
                        <div class="msgr d-flex h-100 flex-column bg-white">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="height-8 px-3 d-flex flex-row align-items-center flex-wrap flex-shrink-0">
                                    <a href="#/" class="btn btn-icon fs-xl width-1 mr-1" data-toggle="tooltip" data-original-title="More options" data-placement="top">
                                        <i class="fal fa-ellipsis-v-alt color-fusion-300"></i>
                                    </a>
                                    <a href="#/" class="btn btn-icon fs-xl mr-1" data-toggle="tooltip" data-original-title="Attach files" data-placement="top">
                                        <i class="fal fa-paperclip color-fusion-300"></i>
                                    </a>
                                    <a href="#/" class="btn btn-icon fs-xl mr-1" data-toggle="tooltip" data-original-title="Insert photo" data-placement="top">
                                        ...
                                        <div id="skin-default" data-action="toggle-replace" data-replaceclass="mod-skin-light mod-skin-dark" data-class="" data-toggle="tooltip" data-placement="top" title="" class="d-flex bg-white border border-primary rounded overflow-hidden text-success js-waves-on" data-original-title="Default Mode" style={{height: "80px"}}>
                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                ...
                                                <div class="bg-faded flex-1 pt-3 pb-3 px-2">
                                                    <div class="py-3" style={{background:"url('img/demo/s-1.png') top left no-repeat", backgroundSize: "100%"}}></div>
                                                </div>
                                            </div>
                                        </div>
                                        Default
                                        ...
                                        <div id="skin-dark" data-action="toggle-replace" data-replaceclass="mod-skin-light" data-class="mod-skin-dark" data-toggle="tooltip" data-placement="top" title="" class="d-flex bg-white border border-dark rounded overflow-hidden text-success js-waves-on" data-original-title="Dark Mode" style={{height: "80px"}}>
                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                ...
                                                <div class="bg-fusion-300 flex-1 pt-3 pb-3 px-2">
                                                    <div class="py-3 opacity-30" style={{background:"url('img/demo/s-1.png') top left no-repeat", backgroundSize: "100%"}}></div>
                                                </div>
                                            </div>
                                        </div>
                                        Dark
